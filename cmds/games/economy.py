...
class Economy(Cog_Extension):
  @commands.command(aliases=['SHOP', 'Shop', 'sHOP', 'shOP', 'shoP'])
  ...
  @commands.command(aliases=['BAG', 'Bag'])
  ...
  @commands.command(aliases=['Menu', 'MENU'])
  ...
  @commands.command(aliases=['TOP', 'Top'])
  ...
  @commands.command(name='register', aliases=['reg','開戶','REG'])
  async def register(self, ctx):       
        await ctx.send(core.account.register(ctx.message.author.id)); 
        return

  @commands.command(aliases=['BANK', 'Bank','bal','BAL'])
  ...
  @commands.command(name='salary', aliases=['SY','薪水','SALARY','Salary'])
  ...
  @commands.command(aliases=['PAY', 'Pay'])
  ...
  @commands.command(aliases=['PAYDAY', 'Payday'])
  ...
  @commands.command(aliases=['SROB', 'Srob'])
  ...
  @commands.command(aliases=['COUNT', 'Count'])
